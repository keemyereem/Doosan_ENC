...
var commonEvent = {
  ...
  headerEvent: () => {
    ...
    $('#sub .header .gnb > ul > li').hover(function(){
      if($('.header').hasClass('wht')){
          $('.header').removeClass('wht');
          $('.header').css({'background':'#fff'});
      }
...
var techEvent = {
  ...
  motion : () => {
    ...
    .to('.four', { boxShadow: '0 0 0 90px #005EB8', border: '0px solid #005EB8', duration: .6, delay: .3 })
    .to('.four li, .box > li:not(:last-child)', { opacity: 0, duration: .2, delay: 1 }, "=-.6")
    .to('.four', { scale: 1.9, background: "#005EB8", boxShadow: '0 0 0 0px #005EB8', duration: .6 }, "=-.6")
    .to('.box', { duration: .6, background: 'rgba(153, 205, 255, .2)' }, "=-.6")
    ...
    .to('.four', { x: 516, scale: 1, duration: 0, clearProps: "box-shadow", }, "=-.3")
